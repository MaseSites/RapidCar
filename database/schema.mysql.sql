...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    condition_state    VARCHAR(20) DEFAULT NULL,
    cylinders          TINYINT UNSIGNED DEFAULT NULL,
    engine_layout      VARCHAR(20) DEFAULT NULL,
    gears              TINYINT UNSIGNED DEFAULT NULL,
    consumption        DECIMAL(5,2) DEFAULT NULL,
    co2_emission       SMALLINT UNSIGNED DEFAULT NULL,
    energy_class       VARCHAR(3) DEFAULT NULL,
    euro_norm          VARCHAR(30) DEFAULT NULL,
    length_mm          SMALLINT UNSIGNED DEFAULT NULL,
    width_mm           SMALLINT UNSIGNED DEFAULT NULL,
    height_mm          SMALLINT UNSIGNED DEFAULT NULL,
    weight_empty_kg    SMALLINT UNSIGNED DEFAULT NULL,
    weight_total_kg    SMALLINT UNSIGNED DEFAULT NULL,
    payload_kg         SMALLINT UNSIGNED DEFAULT NULL,
    type_certificate   VARCHAR(20) DEFAULT NULL,
    license_category   VARCHAR(5) DEFAULT NULL,
    is_import          TINYINT(1) DEFAULT NULL,
    is_tuned           TINYINT(1) DEFAULT NULL,
    is_race_car        TINYINT(1) DEFAULT NULL,
    is_accessible      TINYINT(1) DEFAULT NULL,
    has_mfk            TINYINT(1) DEFAULT NULL,
    ...
    last_mfk           VARCHAR(7)   DEFAULT NULL,
    wheelbase_mm       SMALLINT UNSIGNED DEFAULT NULL,
    towing_capacity_kg SMALLINT UNSIGNED DEFAULT NULL,
    new_price          DECIMAL(10,2) DEFAULT NULL,
    stamm_number       VARCHAR(30)  DEFAULT NULL,
